...
namespace BankSystem
{
    public partial class deposit : Form
    {
        ...
        private void accNoSearchBtn_Click(object sender, EventArgs e)
        {
            cmd.CommandText = "SELECT * FROM Account WHERE AccNo='" + accNoSearch.Text + "'";
            r = cmd.ExecuteReader();
            if(!r.Read())
            {
        ...
        {
            SqlDataReader data;
            cmd.CommandText = "INSERT INTO Deposits VALUES('" + RegNo + "', "+amtTxt.Text+", '"+ DateTime.Now.ToString("M/d/yyyy") +"')";
            data = cmd.ExecuteReader();
            MessageBox.Show("You have successfully deposited £" + amtTxt.Text);
